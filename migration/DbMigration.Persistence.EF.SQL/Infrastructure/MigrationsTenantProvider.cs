...
namespace DbMigration.Persistence.EF.SQL.Infrastructure;
...
public class MigrationsTenantProvider : ITenantProvider
{
    ...
    public string ConnectionString => "Persist Security Info=True;Integrated Security=true;Server=JSS\\SQLEXPRESS;Database=InitDB;";
