...
using UniversalJurayEop.Domain.Settings;
using UniversalJurayEop.Infrastructure.Identity.Helpers;
using static UniversalJurayEop.Domain.Enumeration.Enum;

namespace UniversalJurayEop.Infrastructure.Identity.Services
{
    public class AccountService : IAccountService
    {
        ...
        public AccountService(UserManager<Profile> userManager, 
        ...
        private async Task<JwtSecurityToken> GenerateJWToken(Profile user)
        {
        ...
        private async Task<string> SendVerificationEmail(Profile user, string origin)
        {
